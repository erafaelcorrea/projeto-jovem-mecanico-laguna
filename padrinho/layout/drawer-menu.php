...
<div class="w-64 min-h-full bg-base-100 text-base-content flex flex-col">
    ...
    <div class="p-4 flex flex-col items-center border-b border-gray-300">
        <div class="avatar indicator">
            <span class="indicator-item badge badge-sm badge-neutral">PADRINHO</span>
            <div class="w-24 rounded-full">
                <img src="<?= getFotoPadrinho($_SESSION['padrinho']['padrinho_id']) ?>" />
            </div>
        </div>

        <span class="mt-2 font-semibold">
            <?= $_SESSION['padrinho']['padrinho_nome']; ?>
        </span>
    </div>
