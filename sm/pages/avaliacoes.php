<?php
$avaliacoes = GlobalModel::retornarUmaLista("SELECT * FROM avaliacao ORDER BY id DESC");
?>
        ...
        <?php foreach ($avaliacoes as $index => $avaliacao): ?>
            ...
            ?>
                ...
                <td>
                    <div class="">
                        <div class="avatar indicator">
                            <span class="indicator-item badge badge-xs badge-neutral"><?= $quem_avaliou['badge'] ?></span>
                            <div class="w-8 rounded-full mt-2"><img src="<?= $quem_avaliou['foto'] ?>" /></div>
                        </div>
                ...
                <td>
                    <div class="">
                        <div class="avatar indicator">
                            <span class="indicator-item badge badge-xs badge-neutral"><?= $avaliado['badge'] ?></span>
                            <div class="w-8 rounded-full mt-2"><img src="<?= $avaliado['foto'] ?>" /></div>
                        </div>
