...
$avaliacao = GlobalModel::retornarUmObjeto("SELECT * FROM avaliacao WHERE id = {$avaliacao_id}");
...
if (!$avaliacao) {
    ...
    $filtro = $quem_avalia['label'] === "Padrinho" ? "WHERE perfil IN ('padrinho', 'todos')" : "WHERE perfil IN ('afilhado', 'todos')";
    ...
    $perguntas_banco = GlobalModel::retornarUmaLista("SELECT * FROM perguntas {$filtro}");
?>
