...
if (!isset($_SESSION['instrutor']['logado'])) {
        ...
        switch (@$_GET['pagina']) {
            ...
            case "aplicar-nota":
                $dados = [
                    ...
                    'nota' => validarNota($_POST['nota'])
                ];

                $retorno = AvaliacaoModel::aplicarNotaInstrutor($dados);
                
                if($retorno === true) {
                    echo "<script>window.location.href = \"index.php?pagina=alunos&status=success&msg=Nota aplicada com sucesso!\";</script>";
                } else {
                    echo "<script>window.location.href = \"index.php?pagina=alunos&status=error&msg=Erro ao salvar nota.\";</script>";
                }
            ...
            case "responder":
                ...
                $retorno = GlobalModel::responderAvaliacaoInstrutor($dados);
