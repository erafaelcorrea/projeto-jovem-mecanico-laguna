...
<div class="w-full flex justify-between p-4">
    <span class="text-2xl">AVALIAÇÃO TÉCNICO COMPORTAMENTAL DO INSTRUTOR</span>
    <a href="index.php?pagina=relatorio&origem=<?= encrypt($afilhado_id) ?>" class="btn btn-neutral btn-sm">VOLTAR <i class="fa fa-mail-reply"></i></a>
</div>
