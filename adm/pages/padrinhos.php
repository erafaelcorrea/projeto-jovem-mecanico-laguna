...
<div class="w-full flex justify-between p-4">
    <span class="text-2xl">PADRINHOS</span>
    <a href="index.php?pagina=afilhados" class="btn btn-neutral btn-sm">JOVENS MECÂNICOS <i class="fa fa-mail-forward"></i></a>
</div>
                ...
                <td>
                    <div class="avatar">
                        <div class="w-12 rounded-full hover:border hover:border-4 hover:border-yellow-400">
                            <a href="index.php?pagina=padrinho&origem=<?= encrypt($padrinho['id']); ?>"><img src="<?= getFotoPadrinho($padrinho['id']) ?>" /></a>
                        </div>
                    </div>
                </td>
                <td><?= $padrinho['nome']; ?></td>
                <td class="text-center">
                    <?php if ($tem_afilhado_no_momento->id): ?>
                        <div class="flex flex-col gap-1 items-center">
                            <div class="avatar"><div class="w-8 h-8 rounded-full hover:border hover:border-3 hover:border-yellow-400"><a href="index.php?pagina=relatorio&origem=<?= encrypt($tem_afilhado_no_momento->id); ?>"><img src="<?= getFotoAfilhado($tem_afilhado_no_momento->id) ?>" /></a></div></div>
