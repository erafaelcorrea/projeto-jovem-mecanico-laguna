<?php
$perguntas = retornarLista("SELECT * FROM perguntas ORDER BY id desc");
?>
  ...
  <table class="table min-w-full table-auto">
    ...
    <thead>
      <tr>
        ...
        <th class="w-40">Sub-Categoria</th>
    ...
    <tbody>
        <?php foreach ($perguntas as $index => $pergunta): ?>
            <tr>
                ...
                <td><span class="badge bg-neutral-content badge-xs p-2"><?= $pergunta['subcategoria']; ?></span></td>
                <td>
