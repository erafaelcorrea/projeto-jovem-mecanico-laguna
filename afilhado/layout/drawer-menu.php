...
<div class="w-64 min-h-full bg-base-100 text-base-content flex flex-col">
    ...
    <div class="p-4 flex flex-col items-center border-b border-gray-300">
        <div class="avatar indicator">
            <span class="indicator-item badge badge-sm badge-neutral">AFILHADO</span>
            <div class="w-24 rounded-full">
                <img src="<?= getFotoAfilhado($_SESSION['afilhado']['afilhado_id']) ?>" />
            </div>
        </div>

        <span class="mt-2 font-semibold">
            <?= $_SESSION['afilhado']['afilhado_nome']; ?>
        </span>
    </div>
    ...
    <ul class="menu p-4 flex-1">
        ...
        $menu = [
            ...
            ['pagina' => 'avaliacoes', 'label' => 'Avaliações', 'icone'=> 'file'],
